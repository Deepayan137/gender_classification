...
if __name__ == '__main__':
	...
	for i in range(10):
	    X_train, X_test, y_train, y_test = train_test_split(norm, truths, test_size=0.4, random_state=0, stratify=truths)
	    X_train_pca, X_test_pca = pca_decmp(X_train, X_test)
	    param_grid = {'C': [0.00001, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 100000]}
	    clf = GridSearchCV(linear_model.LogisticRegression(penalty='l2', class_weight='balanced'), param_grid)
